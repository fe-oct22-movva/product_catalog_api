...
const getAllPhones = (pageQuery, limitQuery, sortQuery) => __awaiter(void 0, void 0, void 0, function* () {
    let phones = yield phone_1.Phone.findAll();
    const sort = sortQuery || 'newest';
    if (sort) {
...
const getOnePhone = (phoneId) => __awaiter(void 0, void 0, void 0, function* () {
